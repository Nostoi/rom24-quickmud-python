...
class ConfidenceTracker:
    ...
    def record_snapshot(self) -> dict:
        ...
        snapshot = {"timestamp": datetime.now().isoformat(), "scores": self.extract_current_scores()}
    ...
    def print_status_report(self) -> None:
        ...
        print(
            f"Overall Progress: {completed}/{total_subsystems} subsystems completed ({completed / total_subsystems * 100:.1f}%)"
        )
        print()
