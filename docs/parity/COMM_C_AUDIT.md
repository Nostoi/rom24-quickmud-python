...
| COMM-009 | MINOR | `src/comm.c:2178-2182` | `mud/utils/fix_sex.py:fix_sex` | Standalone `fix_sex(ch)` helper extracted; inline clamp in `mud/handler.py` now delegates. | ✅ FIXED |
