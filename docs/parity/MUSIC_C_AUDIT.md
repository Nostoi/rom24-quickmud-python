...
| MUSIC-002 | CRITICAL | `src/music.c:160-218` | _missing_ | No `load_songs` equivalent — `mud/music/song_table` is never populated from `area/music.txt`. The global "MUSIC:" channel and `play list` have nothing to play. | 🔄 OPEN |
