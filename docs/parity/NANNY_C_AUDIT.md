...
| `NANNY-007` | CRITICAL | `nanny.c:804` | `mud/net/connection.py:1554-1601` | `act("$n has entered the game.", TO_ROOM)` broadcast missing on login — other players in the room never see arrivals. | 🔄 OPEN |
