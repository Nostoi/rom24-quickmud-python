...
| `act_wiz.c` | P2 | ⚠️ Partial | `mud/wiznet.py`, `mud/commands/imm_*.py`, `mud/commands/admin_commands.py`, `mud/commands/inventory.py`, `mud/commands/remaining_rom.py` | 65% | Apr 28, 2026 — fourth pass closed WIZ-005 (stat family), WIZ-008 (punish commands wrong flag values), WIZ-009 (peace stop_fighting). See ACT_WIZ_C_AUDIT.md |
