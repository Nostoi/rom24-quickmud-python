...
| `act_wiz.c` | P2 | ⚠️ Partial | `mud/wiznet.py`, `mud/commands/imm_*.py`, `mud/commands/admin_commands.py`, `mud/commands/inventory.py`, `mud/commands/remaining_rom.py` | 85% | Apr 28, 2026 — seventh pass closed WIZ-023..026 (guild, outfit, copyover, qmconfig verified, wiznet broadcast to descriptor_list). See ACT_WIZ_C_AUDIT.md |
