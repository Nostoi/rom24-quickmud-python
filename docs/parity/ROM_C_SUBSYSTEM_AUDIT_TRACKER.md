...
| `act_wiz.c` | P2 | ⚠️ Partial | `mud/wiznet.py`, `mud/commands/imm_*.py`, `mud/commands/admin_commands.py`, `mud/commands/inventory.py`, `mud/commands/remaining_rom.py` | 78% | Apr 28, 2026 — sixth pass closed WIZ-011 through WIZ-022 (echo family, bamfin/bamfout, wizlock/newlock, holylight, slookup, sockets, deny, switch, return, smote, pecho, disconnect). See ACT_WIZ_C_AUDIT.md |
