...
| **OLC (Online Creation)** | | | | | |
| `olc.c` | P2 | ⚠️ Partial | `mud/commands/build.py`, `mud/commands/dispatcher.py`, `mud/commands/imm_olc.py`, `mud/olc/editor_state.py`, `mud/utils/prompt.py` | 58% | 2026-05-01 — audit active. Closed: OLC-INFRA-001, OLC-001..005, OLC-016..023. Remaining open set is structural/editor UX: OLC-006..015 only. See `OLC_C_AUDIT.md`. |
