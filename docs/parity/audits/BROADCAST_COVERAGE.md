...
|---|---------|--------------|-----------|---------|---------|------------|--------|----------|--------|-------|
| 1 | `@goto` | `mud/commands/build.py:3930` | `src/act_wiz.c:905` | 0 | 4 | 0 | 0 | 0 | ❌ | **BCAST-001** — ROM has 4 non-TO_CHAR act() but Python has 0 broadcast hits. Py indicators: (no broadcast hits) |
...
| 3 | `close` | `mud/commands/doors.py:181` | `src/act_move.c:425` | 3 | 0 | 0 | 0 | 0 | ❌ | **BCAST-003** — ROM has 3 non-TO_CHAR act() but Python has 0 broadcast hits. Py indicators: (no broadcast hits) |
| 4 | `dirt` | `mud/commands/combat.py:839` | `src/fight.c:2349` | 1 | 1 | 0 | 0 | 0 | ❌ | **BCAST-004** — ROM has 2 non-TO_CHAR act() but Python has 0 broadcast hits. Py indicators: (no broadcast hits) |
| 5 | `disarm` | `mud/commands/combat.py:963` | `src/fight.c:2995` | 0 | 1 | 1 | 0 | 0 | ❌ | **BCAST-005** — ROM has 2 non-TO_CHAR act() but Python has 0 broadcast hits. Py indicators: (no broadcast hits) |
...
| 8 | `goto` | `mud/commands/imm_commands.py:164` | `src/act_wiz.c:905` | 0 | 4 | 0 | 0 | 0 | ❌ | **BCAST-008** — ROM has 4 non-TO_CHAR act() but Python has 0 broadcast hits. Py indicators: (no broadcast hits) |
...
| 11 | `incognito` | `mud/commands/imm_display.py:54` | `src/act_wiz.c:4298` | 3 | 0 | 0 | 0 | 0 | ❌ | **BCAST-011** — ROM has 3 non-TO_CHAR act() but Python has 0 broadcast hits. Py indicators: (no broadcast hits) |
| 12 | `invis` | `mud/commands/imm_display.py:18` | `src/act_wiz.c:4252` | 3 | 0 | 0 | 0 | 0 | ❌ | **BCAST-012** — ROM has 3 non-TO_CHAR act() but Python has 0 broadcast hits. Py indicators: (no broadcast hits) |
| 13 | `lock` | `mud/commands/doors.py:276` | `src/act_move.c:539` | 3 | 0 | 0 | 0 | 0 | ❌ | **BCAST-013** — ROM has 3 non-TO_CHAR act() but Python has 0 broadcast hits. Py indicators: (no broadcast hits) |
...
| 16 | `open` | `mud/commands/doors.py:97` | `src/act_move.c:313` | 3 | 0 | 0 | 0 | 0 | ❌ | **BCAST-016** — ROM has 3 non-TO_CHAR act() but Python has 0 broadcast hits. Py indicators: (no broadcast hits) |
...
| 25 | `surrender` | `mud/commands/combat.py:548` | `src/fight.c:3072` | 0 | 1 | 1 | 0 | 0 | ❌ | **BCAST-025** — ROM has 2 non-TO_CHAR act() but Python has 0 broadcast hits. Py indicators: (no broadcast hits) |
| 26 | `trip` | `mud/commands/combat.py:880` | `src/fight.c:2501` | 1 | 1 | 1 | 0 | 0 | ❌ | **BCAST-026** — ROM has 3 non-TO_CHAR act() but Python has 0 broadcast hits. Py indicators: (no broadcast hits) |
| 27 | `unlock` | `mud/commands/doors.py:373` | `src/act_move.c:674` | 3 | 0 | 0 | 0 | 0 | ❌ | **BCAST-027** — ROM has 3 non-TO_CHAR act() but Python has 0 broadcast hits. Py indicators: (no broadcast hits) |
