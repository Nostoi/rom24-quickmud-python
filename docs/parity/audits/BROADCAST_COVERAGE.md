...
| 14 | `mload` | `mud/commands/imm_load.py:52` | `src/act_wiz.c:2447` | 1 | 0 | 0 | 0 | 0 | ❌ | **BCAST-014** — ROM `act("$n has created $N!", ch, NULL, victim, TO_ROOM)` at `src/act_wiz.c:2512`. WIZLOAD-001 unblocked the success path; standard `rom-gap-closer` adds the TO_ROOM emit after the spawn/placement. |
