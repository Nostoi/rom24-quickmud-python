...
> single capitalization step at the act-render boundary (not per-callsite). Filed
> here as a finding while closing WIZ-048; promote to a stable cross-file ID
> (INV-028 ACT-SENTENCE-CASE) when picked up. The WIZ-047/048/049 tests assert
