...
5. ✅ **do_train()**: Stat training implemented (TRAIN-001 crash regression fixed 2.8.77; TRAIN-002 cost-always-1 fixed — ROM has NO prime/non-prime cost split; TRAIN-003 trainer-presence check OPEN — see Gap Table below)
