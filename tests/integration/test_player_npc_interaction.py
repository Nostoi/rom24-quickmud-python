...
class TestGroupFormation:
    ...
    def test_grouped_player_moves_with_leader(self, test_player, test_mob, test_room):
        ...
        # Create north room
        north_room = Room(vnum=1002, name="North Room", description="A room to the north.", room_flags=0, sector_type=0)
        north_room.people = []
        north_room.contents = []
...
class TestCombatInteraction:
    ...
    def test_flee_from_combat(self, test_player, test_mob, test_room):
        ...
        # Create escape room
        escape_room = Room(vnum=1001, name="Escape Room", description="A safe place.", room_flags=0, sector_type=0)
        escape_room.people = []
