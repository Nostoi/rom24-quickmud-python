        ...
        if line.startswith("#"):
            ...
            while True:
                ...
                if peek.startswith("E"):
                    ...
                    location = (
                        int(affect_line[0]) if len(affect_line) > 0 and affect_line[0].lstrip("-").isdigit() else 0
                    )
                    modifier = (
                        int(affect_line[1]) if len(affect_line) > 1 and affect_line[1].lstrip("-").isdigit() else 0
                    )
