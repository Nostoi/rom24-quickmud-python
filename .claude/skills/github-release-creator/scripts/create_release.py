...
def main():
    parser = argparse.ArgumentParser(description="Create GitHub release with smart defaults")
    parser.add_argument("version", help="Version number (with or without 'v' prefix)")
    parser.add_argument("-t", "--title", help="Release title")
    parser.add_argument("-n", "--notes", help="Release notes (inline)")
    parser.add_argument("-f", "--notes-file", help="Release notes from file")
    parser.add_argument("-g", "--generate-notes", action="store_true", help="Auto-generate release notes from commits")
    parser.add_argument("-d", "--draft", action="store_true", help="Create as draft release")
    parser.add_argument("-p", "--prerelease", action="store_true", help="Mark as pre-release")
    parser.add_argument("--target", help="Target branch or commit SHA")
    parser.add_argument("-a", "--assets", nargs="+", help="Asset files to upload")
