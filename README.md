...
[![Version](https://img.shields.io/badge/version-2.11.21-blue.svg)](https://github.com/Nostoi/rom24-quickmud-python)
...
- **Test Suite**: ✅ **4963 passed, 4 skipped**. Three layers — unit (`tests/test_*.py`),
