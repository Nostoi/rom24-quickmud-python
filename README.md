...
[![Version](https://img.shields.io/badge/version-2.11.32-blue.svg)](https://github.com/Nostoi/rom24-quickmud-python)
...
- **Test Suite**: ✅ **4985 passed, 4 skipped, 1 xfailed**. Three layers — unit (`tests/test_*.py`),
