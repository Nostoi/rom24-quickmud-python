...
[![Version](https://img.shields.io/badge/version-2.12.44-blue.svg)](https://github.com/Nostoi/rom24-quickmud-python)
[![Python 3.10+](https://img.shields.io/badge/python-3.10+-blue.svg)](https://www.python.org/downloads/)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)
[![Tests](https://img.shields.io/badge/tests-5246%20passing-brightgreen.svg)](https://github.com/Nostoi/rom24-quickmud-python)
...
- **📊 Comprehensive Testing**: 5,246 passing tests across unit, integration, and command-registry suites
...
- **Test Suite**: ✅ **5246 passed, 4 skipped**. Three layers — unit (`tests/test_*.py`),
